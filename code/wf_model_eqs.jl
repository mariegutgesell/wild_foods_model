...
##NO FUCKING WAY!!!!!!!! I THINK THIS WORKS !!!!! 
...
function model_2!(du, u, p ,t)
   ...
   plot(sol_2, xlabel="Time", ylabel="Population", title="ODE Solution")
     ...
     ##so this works, holding P constant. then just need to figure out how to calculate total harvest (just adding 2 functional responses together)
...
##reading and thinking about parameters and how to choose parameters, also different parameters per TL etc. 
 ...
 ##much later next steps: thinking about perturbations.. 